...
public class TelaExtrato extends JFrame {
	...
	public TelaExtrato() {
		...
		modelo.addRow(new Object[] { "22/05/2026", "Transporte", "Uber para o trabalho", "Saída", "-R$ 25,90" });
		modelo.addRow(new Object[] { "21/05/2026", "Moradia", "Conta de luz", "Saída", "-R$ 210,40" });
		modelo.addRow(new Object[] { "20/05/2026", "Investimentos", "Aplicação Tesouro Direto", "Entrada", "R$ 300,00" });
		modelo.addRow(new Object[] { "19/05/2026", "Alimentação", "Jantar fora", "Saída", "-R$ 89,90" });
		modelo.addRow(new Object[] { "18/05/2026", "Compras", "Roupa", "Saída", "-R$ 120,00" });
		modelo.addRow(new Object[] { "17/05/2026", "Outros", "Venda de item usado", "Entrada", "R$ 200,00" });
